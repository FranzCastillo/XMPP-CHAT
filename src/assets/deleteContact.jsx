// src/assets/options.jsx
import React, {createElement} from 'react';

const DeleteContact = ({height = "25px", width = "25px"}) => (
    createElement('svg', {
